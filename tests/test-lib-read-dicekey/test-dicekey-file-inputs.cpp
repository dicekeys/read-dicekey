...
void testFileWithObj(
  ...
  cv::Mat bgraImage = cv::imread("tests/test-lib-read-dicekey/img/" + filePath, cv::IMREAD_COLOR);
...
TEST(DiceKeyImageReaderFileTests, B21U11Z30O62W51C10D22T22F61X52I11R30L21H52A22K11P40J33V51Y41M33S20N63E60G32) {
...
//  std::cerr << "Using base path" << basePath;
	...
	cv::Mat colorImage = cv::imread("tests/test-lib-read-dicekey/img/" + filePath, cv::IMREAD_COLOR);
